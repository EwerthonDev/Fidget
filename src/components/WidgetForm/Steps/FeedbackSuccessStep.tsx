        ...
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[384px]">
                ...
                <button 
                    ...
                    className="py-2 px-6 mt-6 bg-pink-500 rounded-md border-transparent text-sm leading-6 hover:bg-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-pink-500"
                >
